...
class ChatServiceTest {
    ...
    void users_can_post_and_receive_messages() {
    ...
    void simultaneously_posted_messages_are_grouped_together_to_save_bandwidth() {
        var liveMessages = chatService.liveMessages(knownChannelId);
        var verifier = StepVerifier
                .create(liveMessages)
    ...
    void users_can_fetch_message_history() {
        chatService.postMessage(knownChannelId, "message1");
        chatService.postMessage(knownChannelId, "message2");
    ...
    void posting_to_nonexistent_channel_throws_exception() {
    ...
    void fetching_message_history_of_nonexistent_channel_returns_empty_list() {
